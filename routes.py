...
routes = [
    ...
    url(r"/statistic/users", handlers.web.StatisticHandler, name="web:statistic-users"),
    ...
    url(r"/settings/account/edit", handlers.web.EditUserHandler, name="web:edit-user"),
    url(r"/settings/tokens/new", handlers.web.NewTokenHandler, name="web:new-token"),
    url(r"/settings/tokens/([0-9]+)/del", handlers.web.DelTokenHandler, name="web:del-token"),
    ...
    url(r"/([^/]+)/([^/]+)/edit", handlers.web.EditRepoHandler, name="web:edit-repo"),
